...
# Download NetBeans CopyLibs task JAR
RUN wget https://repo1.maven.org/maven2/org/netbeans/external/org-netbeans-modules-java-j2seproject-copylibstask/RELEASE82/org-netbeans-modules-java-j2seproject-copylibstask-RELEASE82.jar -O /app/org-netbeans-modules-java-j2seproject-copylibstask.jar
...
RUN cd ch07_ex1_download && \
    ant -f build.xml dist -Dlibs.dir=/app/libs -Dservlet-api.jar=/app/javax.servlet-api-4.0.1.jar -Dlibs.CopyLibs.classpath=/app/org-netbeans-modules-java-j2seproject-copylibstask.jar
